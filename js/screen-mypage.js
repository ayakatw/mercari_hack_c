        ...
        '<section class="screen screen-mypage">',
          ...
          '<div class="screen-scroll mypage-scroll">',
            '<section class="my-profile">',
              '<div class="profile-main"><div class="profile-avatar"><img src="assets/img/avatar-rina.svg" alt="りなのアイコン"><span>✦</span></div><div class="profile-names"><h2>りな</h2><p>@rina_oshi</p></div><div class="post-stat"><strong>' + grid.length + '</strong><span>投稿</span></div></div>',
