(function (global) {
  ...
  function photoRow(item) {
    var slots = [
      '<div class="ml-slot is-filled" data-listing-photo><img src="' + item.thumb + '" alt="' + item.name + 'の出品写真"><span class="ml-slot-num">1</span></div>',
      ...
      '<section class="screen listing-screen">',
        ...
        '<div class="screen-scroll ml-scroll">',
          ...
          '<div class="ml-block">',
            ...
            '<div class="ml-input" data-listing-field>' + item.name + '</div>',
          '</div>',
          ...
          '<div class="ml-block">',
            ...
            '<div class="ml-input ml-textarea" data-listing-field>' + description(item) + '</div>',
          '</div>',
          saleTypeBlock(item),
          '<div class="ml-terms">',
