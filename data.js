(function (global) {
  ...
  var IMG = 'assets/img/';
  var HISTORY_LABELS = ['8/3', '8/4', '8/5', '8/6', '8/7', '8/8', '8/9', '8/10', '8/11', '8/12', '8/13', '8/14', '8/15', '8/16', '8/17', '8/18', '8/19', '8/20', '8/21', '8/22', '8/23', '8/24', '8/25', '8/26', '8/27', '8/28', '8/29', '8/30', '8/31', '9/1'];
  ...
  var POSTS = [
    {
      ...
      caption: '今日の祭壇、淡いブルーでまとめたよ🫧 ずっと眺めていられる…！',
      likes: 128,
      tags: ['ステライト 祭壇'],
      giveaway: false
    },
    {
      ...
      caption: 'ステラのアクスタが重なったので、次のステラ推しさんへ継承したいです💫',
      likes: 86,
      tags: ['ステラ アクリルスタンド'],
      giveaway: true
    },
    {
      ...
      caption: 'ツアービジュのステラ、光の入り方まで最高。大切に保管します。',
      likes: 214,
      tags: ['ステラのトレカ'],
      giveaway: false
    },
    {
      ...
      caption: 'ぬいとカフェ巡り☕ ラベンダーのリボンをおそろいにしたよ。',
      likes: 73,
      tags: ['ステラ マスコットぬい'],
      giveaway: false
    },
    {
      ...
      caption: '日本ツアー発表おめでとう！このペンライトをまた振れる日が来る🌟',
      likes: 302,
